...
interface MaximizedChatConversationProps {
  isVisible: boolean;
  onBackClick: () => void;
...
const MaximizedChatConversation: React.FC<MaximizedChatConversationProps> = ({
  isVisible,
  onBackClick,
  onTypingStateChange,
  ...
  return (
    <div className="chat-conversation-partent">
      <div
        style={{
      ...
      >
        ...
        />
        <div 
        className="chat-main-content with-sidebar"
        >
          ...
          <div
            className={`chat-instructional-sidebar ${
              internalShowInstructionalPanel ? "expanded" : "collapsed"
            }`}
          >
            {!internalShowInstructionalPanel ? (
              <div className="chat-vector" onClick={handleVectorClick}>
                <img src={vector} alt="help" style={{ marginTop: "6px" }} />
              </div>
            ) : (
              <>
                <InstructionalPanel
                  isOpen={internalShowInstructionalPanel}
                  onClose={() => setInternalShowInstructionalPanel(false)}
                  isInternal={true}
                  isMaximized={true}
                />
              </>
...
export default MaximizedChatConversation;